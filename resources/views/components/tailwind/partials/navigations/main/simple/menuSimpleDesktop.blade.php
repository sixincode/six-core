...
<div class="relative justify-between flex">
  ...
  <div class="flex flex-1 items-center justify-center lg:items-stretch lg:justify-start">
    ...
    <div class="hidden sm:ml-6 lg:flex lg:space-x-3 sm:py-2 relative">

    <x-hive-display-mega-menu class="absolute" align="left" width="2xl">
        <x-slot name="trigger">
          <x-hive-display-link
            title='{{__("Domains")}} & {{__("Websites")}}'
            url='#'
            current='{{request()->routeIs( "central.domains.*")}}'
            base='six-core::components'
            component='mainSimpleNavPill'
            icon='domain'
            iconWidth='1.5'/>
        </x-slot>
        <x-slot name="content">
          ...
          <x-hive-display-link
            ...
            component='main.simple.sectionDomain' />
        </x-slot>
     </x-hive-display-mega-menu>

     <x-hive-display-mega-menu class="absolute left-0" align="false" width="2xl">
         <x-slot name="trigger">
           <x-hive-display-link
             title='{{__("Hostings")}}'
             url='#'
         ...
         <x-slot name="content">
           ...
           <x-hive-display-link
             base='six-core::components'
             source='partials.navigations'
             component='main.simple.sectionWebHosting' />
         </x-slot>
      </x-hive-display-mega-menu>
      ...
      <x-hive-display-mega-menu class="absolute left-0" align="false" width="2xl">
          ...
          <x-slot name="content">
            ...
            <x-hive-display-link
              base='six-core::components'
              source='partials.navigations'
              component='main.simple.sectionTools' />
          </x-slot>
      </x-hive-display-mega-menu>
      ...
      <x-hive-display-mega-menu class="absolute left-0" align="false" width="2xl">
          ...
          <x-slot name="content">
            ...
            <x-hive-display-link
              base='six-core::components'
              source='partials.navigations'
              component='main.simple.sectionResources' />
          </x-slot>
      </x-hive-display-mega-menu>
    </div>
  </div>
